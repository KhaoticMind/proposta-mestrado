...
\begin{itemize}
	...
	\item Implementar um produto de software usando as técnicas de NLP estudadas acima, para geração de abstrações de \emph{logs} que possam detectar as entidades que fazem parte do mesmo;
...
Para o nosso trabalho iremos utilizar o repositório de \emph{logs} \url{http://www.secrepo.com/}, que é mantido por membros da comunidade de segurança da informação. No decorrer de nosso trabalho iremos identificar quais \emph{logs} desse repositório melhor se adequarão ao nosso trabalho.
